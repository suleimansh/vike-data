// A normal, hand-written vike-react page. The table in the middle is vike-crud's <ListView> block,
...
export default function InlinePage() {
  ...
  return (
    <div style={{ maxWidth: 720, margin: '2rem auto', fontFamily: 'system-ui, sans-serif', lineHeight: 1.6 }}>
      ...
      <p>
        This page is ordinary vike-react code. The table below is vike-crud's <code>&lt;ListView&gt;</code> block, dropped
