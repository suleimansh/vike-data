// Ejected from vike-view — this page's data layer is now YOURS. There is no generated
...
import { resolveViewTables, buildDb, hydrateView, createRow, updateRow, defineView, resolvePage } from 'vike-view'

const ROUTE = '/posts-ejected'

// Your view, inlined. `sections` is the serializable block IR — edit it directly, or rebuild it
// with crudBlocks / column / field (re-import those from 'vike-view') if you prefer the fluent form.
