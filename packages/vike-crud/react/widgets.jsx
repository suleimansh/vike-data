...
// the built-ins as a side effect (FormFields / FormView import it for exactly that), and
// re-exports `registerFieldWidget` / `getFieldWidget` so an extension adds its own control with
// one import:
//
//   import { registerFieldWidget } from 'vike-crud/react/widgets'
