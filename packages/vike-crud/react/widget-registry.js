...
// shared 'react' field-widget slot, so vike-crud's FormView, vike-admin's form pages, and an
// extension's control (e.g. vike-storage's `file`) all read/register the SAME map — a column
// marked `.as('file')` renders the uploader in any vike-crud form, not just the admin. Plain JS
