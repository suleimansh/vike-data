...
export default {
  ...
  pages: [
    ...
    {
      // `/admin/@table/new` (static segment) keeps precedence over this `@id` param, so the
      // read-only detail view never resolves for a row whose id is literally "new".
      route: '/admin/@table/@id',
      Page: 'import:vike-admin/react/ViewPage:default',
      guard: 'import:vike-admin/guard:adminGuard',
